...
echo.
echo  ========================================
echo   CGPSC Tracker Control
echo  ========================================
echo.
echo   WHAT EACH APP IS:
echo   [1] Tracker      = Website (Streamlit) + Vader sticker
echo   [2] Death Star   = Desktop watcher ONLY (no website)
echo.
echo   Sticker and Death Star do NOT share one process.
echo.
echo   --- START ---
echo   1. Start Tracker (website + Vader sticker)
echo   2. Start Death Star watcher only
echo.
echo   --- STATUS / STOP ---
echo   3. Show what is running now
echo   4. Stop EVERYTHING (website + sticker + death star)
echo   5. Stop Death Star only
